<?php $this->load->view('template_admin/template_start')?>
            <div class="page-body">
                ...
                <div class="card">
                  ...
                  <form class="form theme-form" action="<?= site_url('admin/User/tambah_user')?>" method="post">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          <div class="mb-3 row">
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" type="password" placeholder="Password input" name="password">
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label class="col-sm-3 col-form-label">Alamat</label>
                            <div class="col-sm-9">
                              <input class="form-control digits" type="text" name="alamat">
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label class="col-sm-3 col-form-label" >Level</label>
                            <div class="col-sm-9">
                            <select name="level" class="form-select btn-square digits" readonly i>
