<div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="<?= site_url('Dashboard')?>"><img class="img-fluid" src="<?= base_url()?>assets/admin/images/logo/logo.png" alt=""></a></div>
              ...
              <li class="profile-nav onhover-dropdown p-0 me-0">
                <div class="media profile-media"><img class="b-r-10" src="<?= base_url()?>assets/admin/images/dashboard/profile.jpg" alt="">
                  <div class="media-body"><span><?= $this->session->userdata('nama') ?></span>
                    <p class="mb-0 font-roboto"><?= $this->session->userdata('bagian') ?><i class="middle fa fa-angle-down"></i></p>
                  </div>
                </div>
